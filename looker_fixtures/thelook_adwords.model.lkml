...
explore: events{
  ...
  description: "Explore website event-level data including page views, cart actions, and purchases. Join with sessions, users, ad events, keywords, ad groups, and campaigns to analyze the full digital marketing funnel from ad impression to conversion."
  join: sessions {
...
explore: sessions{
  ...
  description: "Explore session-level data for marketing attribution analysis. Supports first-touch, last-touch, and multi-touch linear attribution models to measure campaign effectiveness, ROI, and revenue contribution across traffic sources."
  join: adevents {
    relationship: many_to_one
