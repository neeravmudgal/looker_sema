view: user_purchase_facts {
  ...
  dimension: user_id {
    description: "Foreign key to the user — links purchase preference data to the user profile"
    hidden: yes
    type: number
    sql: ${TABLE}.user_id ;;
  }
  ...
  dimension: preferred_category {
    description: "The product category where the user has spent the most money, indicating their primary shopping preference"
    view_label: "Users"
    type: string
